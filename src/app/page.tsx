...
import { BuyMeCoffee } from "@/components/BuyMeACoffee"
...
export default function PortfolioLayout() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#232324]">
      ...
      {/* <Chatbot /> */}
  <div className="hidden lg:flex fixed bottom-4 right-4 z-50 cursor-pointer">
<BuyMeCoffee 
  classname="w-48 h-36 flex items-center justify-center"
  textSvgClassName="fill-current text-gray-800 w-12"
/>
  </div>
    </div>
  )
